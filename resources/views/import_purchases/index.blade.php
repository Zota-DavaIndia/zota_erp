            ...
            @component('components.widget')
                {!! Form::open(['url' => action([\App\Http\Controllers\ImportPurchasesController::class, 'preview']), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                {!! Form::file('purchases_file', ['required' => 'required']); !!}
                              </div>
                        </div>
                        <div class="col-sm-4">
                        <br>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <a href="{{ asset('files/import_purchases_template.xlsx') }}" class="tw-dw-btn tw-dw-btn-success tw-text-white" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-condensed">
                ...
                <tr>
                    <td>2.</td>
                    <td>@lang('lang_v1.choose_purchase_location')</td>
                </tr>
                <tr>
                    <td>3.</td>
                    <td>
                ...
                <tr>
                    <td>5.</td>
                    <td class="text-danger">@lang('lang_v1.import_purchase_all_or_nothing_note')</td>
                </tr>
            </table>
            @endcomponent
        </div>
                ...
                <tbody>
                    @foreach($imported_purchases_array as $key => $value)
                        <tr>
                            ...
                            @can('purchase.delete')
                                <td><a href="{{action([\App\Http\Controllers\ImportPurchasesController::class, 'revertPurchaseImport'], $key)}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error revert_import"><i class="fas fa-undo"></i> @lang('lang_v1.revert_import')</a></td>
                            @endcan
                        </tr>
                    @endforeach
                </tbody>
