@extends('layouts.app')
@section('title', __('lang_v1.preview_imported_purchases'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.preview_imported_purchases')</h1>
</section>

<!-- Main content -->
<section class="content">
    {!! Form::open(['url' => action([\App\Http\Controllers\ImportPurchasesController::class, 'import']), 'method' => 'post', 'id' => 'import_purchase_form']) !!}
