...
<div class="modal-body">
        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th class="text-right add_without_price_hide">@lang( 'lang_v1.unit_cost_before_discount' )</th>
              <th class="text-right add_without_price_hide">@lang( 'lang_v1.discount_percent' )</th>
              <th class="no-print text-right add_without_price_hide">@lang('purchase.unit_cost_before_tax')</th>
              <th class="no-print text-right add_without_price_hide">@lang('purchase.subtotal_before_tax')</th>
              <th class="text-right add_without_price_hide">@lang('sale.tax')</th>
              <th class="text-right add_without_price_hide">@lang('purchase.unit_cost_after_tax')</th>
              @if($purchase->type != 'purchase_order')
              ...
              @endif
              @endif
              <th class="text-right add_without_price_hide">@lang('sale.subtotal')</th>
            </tr>
          </thead>
          @php 
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td class="text-right add_without_price_hide"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->pp_without_discount}}</span></td>
              <td class="text-right add_without_price_hide"><span class="display_currency">{{ $purchase_line->discount_percent}}</span> %</td>
              <td class="no-print text-right add_without_price_hide"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->purchase_price }}</span></td>
              <td class="no-print text-right add_without_price_hide"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->quantity * $purchase_line->purchase_price }}</span></td>
              <td class="text-right add_without_price_hide"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->item_tax }} </span> <br/><small>@if(!empty($taxes[$purchase_line->tax_id])) ( {{ $taxes[$purchase_line->tax_id]}} ) </small>@endif</td>
              <td class="text-right add_without_price_hide"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->purchase_price_inc_tax }}</span></td>
              @if($purchase->type != 'purchase_order')
              @if(session('business.enable_lot_number'))
              ...
              @endif
              @endif
              <td class="text-right add_without_price_hide"><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->purchase_price_inc_tax * $purchase_line->quantity }}</span></td>
            </tr>
            @php 
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-xs-12 add_without_price_hide">
      <h4>{{ __('sale.payment_info') }}:</h4>
    </div>
    <div class="col-md-6 col-sm-12 col-xs-12 add_without_price_hide">
      <div class="table-responsive">
        <table class="table">
          <tr class="bg-green">
            <th>#</th>
    ...
    @endif
    <div class="col-md-6 col-sm-12 col-xs-12 add_without_price_hide @if($purchase->type == 'purchase_order') col-md-offset-6 @endif">
      <div class="table-responsive">
        <table class="table">
          <!-- <tr class="hide">
