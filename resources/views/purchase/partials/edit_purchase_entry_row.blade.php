    ...
    id="purchase_entry_table">
        <thead>
              <tr>
                ...
                <th class="add_without_price_hide @if(!session('business.enable_editing_product_from_purchase') || !empty($is_purchase_order)) hide @endif">
                    @lang( 'lang_v1.profit_margin' )
                </th>
                @if(empty($is_purchase_order))
                    <th class="add_without_price_hide">@lang( 'purchase.unit_selling_price') <small>(@lang('product.inc_of_tax'))</small></th>
