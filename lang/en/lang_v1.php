...
return [
    ...
    'po_line_fully_accounted_for' => 'This purchase order line is already fully accounted for (received + damaged + lost = ordered quantity). Raise or resolve a support ticket to receive any further quantity against it.',
    'partial_box_note_breakdown' => '(:usable :unit recovered as usable and added back to stock)',
    'partial_unit' => 'Unit',
    'damage_loss_section' => 'Damage / Loss',
    'usable_qty_section' => 'Usable / Reusable Quantity',
    'usable_qty_help' => 'If a box was opened and part of its contents are still good, record that quantity here - it is added back to stock separately from the damaged/lost amount above.',
    'usable_qty' => 'Usable Qty',
    'raise_support_ticket' => 'Raise Support Ticket',
    'support_ticket' => 'Support Ticket',
    'support_tickets' => 'Support Tickets',
    'my_support_tickets' => 'My Support Tickets',
    'support_ticket_dashboard' => 'Support Ticket Dashboard',
    'ticket_number' => 'Ticket #',
    'ticket_type' => 'Type',
    'ticket_raised_by' => 'Raised By',
    'closure_reason' => 'Closure Reason',
    'closure_note' => 'Closure Note',
    'close_ticket' => 'Close Ticket',
    'ticket_raised_successfully' => 'Support ticket raised successfully',
    'ticket_closed_successfully' => 'Support ticket closed successfully',
    'ticket_already_raised_for_this_entry' => 'A support ticket has already been raised for this damage/loss entry',
    'ticket_already_closed' => 'This support ticket is already closed',
    'ticket_raised' => 'Ticket raised',
    'ticket_closed' => 'Ticket closed',
    'open' => 'Open',
    'closed' => 'Closed',
    'add_progress_log' => 'Add Progress Record',
    'add_progress_log_placeholder' => 'Describe the progress made on this ticket so far...',
    'progress_log_added' => 'Progress update added',
    'progress_log_added_successfully' => 'Progress log added successfully',
    'ticket_closed_no_more_logs' => 'This ticket is closed - no further progress logs can be added.',
    'delayed' => 'Delayed',
    'tat_due_by' => 'Due by',
    'support_ticket_tat_hours' => 'Support Ticket TAT (hours)',
    'tooltip_support_ticket_tat_hours' => 'How many hours a support ticket has to be resolved in before it is automatically flagged as Delayed on the dashboard.',
    'quantity_to_resend' => 'Quantity to resend',
    'not_resend_closure_help' => 'The Purchase Order will be marked Completed and no further GRNs will be allowed against it. This entry is treated as permanently resolved.',
    'resend_closure_help' => 'Exactly the damaged/lost quantity below will be authorized for one new GRN from the warehouse. No additional quantity beyond this will be permitted.',
