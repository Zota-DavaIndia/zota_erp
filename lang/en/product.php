...
return [
    ...
    */
    ...
    'unit' => 'Base Unit',
    'base_unit_help' => 'Lowest unit &mdash; stock is tracked in this unit',
    'base_unit_tooltip' => 'Pick the LOWEST unit this product is sold in (e.g. Tablet for a medicine). Stock accounting, variations, and pricing are all per-base-unit. Use the Related Sub Units field to add Strip / Baby Box / etc. and set the Default Sale / Purchase Unit for quick selection at POS and purchase entry.',
    'brand' => 'Brand',
    'tax' => 'Tax',
    'sku' => 'SKU',
    ...
    'imported_synced_to_stores' => ':count product(s) flagged as master and synced to all stores.',
