    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            ...
            if ($this->moduleUtil->isSuperadminInstalled()) {
                try {
                    \Modules\Superadmin\Http\Controllers\SuperadminProductController::syncAllProductsToBusiness($business);
                } catch (\Exception $e) {
                    \Log::error('Master product sync to new business failed: ' . $e->getMessage(), [
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            $checkboxes = ['enable_editing_product_from_purchase',
                ...
                'enable_lot_number', 'enable_damage_loss_tracking', 'enable_racks', 'enable_row', 'enable_position', 'enable_sub_units', ];
